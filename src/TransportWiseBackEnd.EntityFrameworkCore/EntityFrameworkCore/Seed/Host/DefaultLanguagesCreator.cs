...
namespace TransportWiseBackEnd.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TransportWiseBackEndConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TransportWiseBackEndDbContext context)
        {
            _context = context;
        }
